...
2. Inspect the codebase only as needed to understand the current structure, constraints, and relevant components.
...
5. Match the intended final UI precisely in visual design, spacing, typography, hierarchy, color, and interaction states.
...
The prototype should be the final visual version and should match the eventual implementation verbatim from a visual perspective. The goal is to validate the design direction as the exact UI target before any production code changes are made.
